...
VALUES (SELECT ID FROM USER WHERE NAME = 'Student1', SELECT ID FROM COURSE WHERE TITLE = 'Course1', '2021-09-15'),
       (SELECT ID FROM USER WHERE NAME = 'Student2', SELECT ID FROM COURSE WHERE TITLE = 'Course1', '2021-09-19'),
       (SELECT ID FROM USER WHERE NAME = 'Student3', SELECT ID FROM COURSE WHERE TITLE = 'Course2', '2021-09-16');
